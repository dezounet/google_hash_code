...
if __name__ == '__main__':
    ...
    # Filter on vertical pics
    # TODO: replace this by a vertical merge function
    pics = {k: v for k, v in pics.items() if v.orientation == 1}
    pics_id = list(pics.keys())

    print('Trying to sort %s pics...' % len(pics_id))
    ...
    while keep_going:
        try:
            ...
            if best_score < current_score:
                ...
                print('Better solution not found: %s < %s)' % (current_score, best_score))
